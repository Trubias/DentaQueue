...
<head>
    ...
    <title>Register — DentaQueue</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dq-header nav a:hover { background: #2563eb; color: white; }
        ...
        .dq-hero .icon { font-size: 48px; margin-bottom: 10px; display: block; }
        .dq-hero h1 {
            font-size: clamp(20px, 5vw, 32px);
            font-weight: 800; color: #1e3a5f;
            line-height: 1.25; margin-bottom: 8px;
        }
        .dq-hero h1 span { color: #16a34a; }
        ...
        .dq-card {
            ...
            box-shadow: 0 20px 60px rgba(0,0,0,0.10), 0 4px 16px rgba(22,163,74,0.08);
            padding: 28px 24px;
            z-index: 1;
        ...
        .dq-card h2 { font-size: 20px; font-weight: 700; color: #0f172a; margin-bottom: 3px; }
        .dq-card .subtitle { font-size: 13px; color: #64748b; margin-bottom: 20px; }
        ...
        .input-wrap select { padding-left: 38px; cursor: pointer; }
        ...
        .input-wrap .toggle-pw:hover { color: #16a34a; }
        .input-no-icon { padding-left: 12px !important; }
        ...
        .btn-primary:hover { transform: translateY(-1px); box-shadow: 0 8px 28px rgba(22,163,74,0.4); }
        .btn-primary:active { transform: translateY(0); }
        .btn-secondary {
            width: 100%; padding: 12px;
            background: transparent;
            color: #2563eb; border: 2px solid #2563eb; border-radius: 10px;
        ...
        @media (min-width: 860px) {
            ...
            .dq-hero { text-align: left; flex: 1; max-width: 380px; }
            .dq-card { max-width: 440px; flex-shrink: 0; }
        }
    </style>
</head>
<body>
    ...
    <main class="dq-main">
        ...
        <div class="dq-hero">
            ...
            <h1>Join <span>DentaQueue</span> today</h1>
            <p>Create your patient account to book appointments and receive personalized dental care updates.</p>
        </div>
        ...
        <div class="dq-card">
            ...
            @if($errors->any())
                <div class="inline-error">Please correct the highlighted fields.</div>
            @endif
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            <svg class="input-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="8" r="4"/><path d="M12 12v9M9 18h6"/></svg>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <button type="button" class="toggle-pw" onclick="togglePw('password','eye1a','eye1b')" aria-label="Toggle password">
                            <svg id="eye1a" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                            <svg id="eye1b" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="display:none"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                        </button>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <button type="button" class="toggle-pw" onclick="togglePw('password_confirmation','eye2a','eye2b')" aria-label="Toggle confirm password">
                            <svg id="eye2a" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                            <svg id="eye2b" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="display:none"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                        </button>
                    </div>
                </div>
    ...
    <script>
        function togglePw(fieldId, eyeOpen, eyeClosed) {
